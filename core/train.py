...
#from core.efficientdet_func import EfficientDet
class Trainer():
    def __init__(self, 
                coco_path, 
                dataset_type, 
        ...
        self.train_generator, self.validation_generator = create_generators(
                                                                coco_path,
                                                                self.dataset_type, 
                                                                self.bs, 
                                                                self.phi,
        ...
        self.efficientdet_train_model = EfficientDet(phi = self.phi, num_classes = self.num_classes)
        self.efficientdet_predict_model = EfficientDet_P(phi = self.phi, efficientdet_model = self.efficientdet_train_model)
    ...
    def run(self):
        ...
        return self.efficientdet_train_model.fit(
